<template>
    ...
    <div class="find-transport__shape-bg" style="background-image: url(assets/images/shapes/find-transport-shape-bg.png);"></div>
    <div class="container">
        <div class="find-transport__inner">
            <div class="find-transport__title-box">
                <h3 class="find-transport__title">Looking for the Best
                    <br> logistics Transport Service?
                </h3>
            </div>
            <div class="find-transport__btn-and-call">
                ...
                <div class="find-transport__btn-box">
                    <a href="contact.php" class="thm-btn">Get a Quote<span><i class="icon-right-arrow"></i></span></a>
                </div>
            </div>
        </div>
    </div>
